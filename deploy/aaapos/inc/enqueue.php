...
// Product Share CSS - ONLY on single product pages
if (is_product()) {
    wp_enqueue_style(
        'aaapos-product-share',
        get_template_directory_uri() . '/assets/css/components/product/product-share.css',
        $is_production ? ['mr-main'] : ['mr-components'],
        MR_THEME_VERSION,
        'all'
    );
...
// Product Share JS - ONLY on single product pages
if (is_product()) {
    wp_enqueue_script(
        'aaapos-product-share',
