...
<div id="page" class="site">
    ...
    <header id="masthead" class="site-header" role="banner">
                ...
                <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="<?php esc_attr_e(
                    ...
                    <div class="mobile-search-wrapper">
                        <form role="search" method="get" class="search-form" action="<?php echo esc_url(
                            ...
                            <input 
                                ...
                                name="s"
                            />
                            <button type="submit" class="search-submit" aria-label="<?php esc_attr_e(
                                "Submit search",
                                "macedon-ranges",
                            ); ?>">
                        ...
                        <div class="mobile-account-section">
                            <?php if (is_user_logged_in()):
                                ...
                                <a href="<?php echo esc_url(
                                    ...
                                    <div class="mobile-account-info">
                                        <span class="mobile-account-name"><?php echo esc_html(
                                            $username,
                                        ); ?></span>
                                        <span class="mobile-account-status"><?php esc_html_e(
                                            "View Account",
                                            "macedon-ranges",
                                        ); ?></span>
                                    </div>
                            ...
                            <?php
                                ...
                                <a href="<?php echo esc_url(
                                    ...
                                    <div class="mobile-account-info">
                                        <span class="mobile-account-name"><?php esc_html_e(
                                            "Sign In",
                                            "macedon-ranges",
                                        ); ?></span>
                                        <span class="mobile-account-status"><?php esc_html_e(
                    ...
                    <?php if (has_nav_menu("primary")) {
                        ...
                        echo '<li><a href="' .
                            esc_url(home_url("/")) .
                            '">' .
                            esc_html__("Home", "macedon-ranges") .
                            "</a></li>";
                        if (class_exists("WooCommerce")) {
                            echo '<li><a href="' .
                                esc_url(get_permalink(wc_get_page_id("shop"))) .
                                '">' .
                                esc_html__("Shop", "macedon-ranges") .
                                "</a></li>";
                        }
                        echo '<li><a href="' .
                            esc_url(home_url("/about")) .
                            '">' .
                            esc_html__("About", "macedon-ranges") .
                            "</a></li>";
                        echo '<li><a href="' .
                            esc_url(home_url("/contact")) .
                            '">' .
                            esc_html__("Contact", "macedon-ranges") .
                            "</a></li>";
                        echo "</ul>";
                        echo "</div>";
                    } ?>
                    ...
                    <?php if (class_exists("WooCommerce")): ?>
                               ...
                               aria-label="<?php esc_attr_e(
                                ...
                                <?php if (is_user_logged_in()):
                                    ...
                                    $username = !empty($first_name)
                                        ...
                                        : $display_name;
                                    ?>
                                    <span class="account-username"><?php echo esc_html(
                                        $username,
                                    ); ?></span>
                                <?php
                                endif; ?>
                            ...
                            <?php if (is_user_logged_in()):
                                ...
                                <div class="account-dropdown">
                                    <div class="account-dropdown-header">
                                        <span class="account-name"><?php echo esc_html(
                                            $current_user->display_name,
                                        ); ?></span>
                                        <span class="account-email"><?php echo esc_html(
                        ...
                        <div class="header-cart-wrapper">
                            ...
                            <a href="<?php echo esc_url(wc_get_cart_url()); ?>" 
                               class="header-action cart-link cart-style-<?php echo esc_attr(
                                   $cart_style,
                               ); ?>" 
                               aria-label="<?php esc_attr_e(
                                   "Shopping Cart",
                                ...
                                <?php if (
                                    $cart_style === "icon-count" ||
                                    $cart_style === "icon-total"
                                ): ?>
     ...
     ? esc_html__("item", "macedon-ranges")
     : esc_html__("items", "macedon-ranges"); ?></span>
                                </div>
