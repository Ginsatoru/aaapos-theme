            ...
            <div class="footer-widgets-grid">
                ...
                <div class="footer-widget footer-contact-info">
                    ...
                    <ul class="footer-contact">
                        <?php $address = get_theme_mod('footer_address', '123 Farm Road, Macedon Ranges VIC 3440'); ?>
                        ...
                        <?php $phone = get_theme_mod('footer_phone', '03 5427 3552'); ?>
                        <?php if (!empty($phone)) : ?>
                        ...
                        <?php $email = get_theme_mod('footer_email', 'sales@macedonrangesproducestore.com.au'); ?>
                        <?php if (!empty($email)) : ?>
